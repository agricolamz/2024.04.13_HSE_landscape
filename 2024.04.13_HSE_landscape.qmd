...
Работа очень похожа на то, что мы делаем, но основано на списках литературы: если авторы ссылаются на сходных авторов, значит они, наверное, близки в пространстве.
